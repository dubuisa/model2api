...
def is_compatible_type(input_type: Type) -> bool:
    ...
    try:
        ...
        pass
    try:
        if issubclass(input_type, UploadFile):
            return True
    except Exception:
        pass
    ...
    try:
        # valid list type
        if input_type.__origin__ is list and issubclass(
            input_type.__args__[0], BaseModel
        ):
            return True
    except Exception:
        pass
